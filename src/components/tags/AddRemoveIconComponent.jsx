...
const AddRemoveIconComponent = (props) => {
  let {
    className,
    icon,
    color,
...
AddRemoveIconComponent.defaultProps = {
  icon: "remove",
  iconSize:"sm"
}

AddRemoveIconComponent.propTypes = {
  className: PropTypes.string,
  icon: PropTypes.oneOf(["add","remove","none"]),
